...
{
    public class DatabaseFactory : IDesignTimeDbContextFactory<SchoolPandaContext>
    {
        public SchoolPandaContext CreateDbContext(string[] args)
        {
            var connectionString = GetDefaultSolutionConnectionString(Directory.GetCurrentDirectory());

            var optionsBuilder = new DbContextOptionsBuilder<SchoolPandaContext>();
            optionsBuilder.UseSqlServer(connectionString);

            return new SchoolPandaContext(optionsBuilder.Options);
        }
